                                                                                                         ...
                                                                                                         for (var bb =0; bb<1.5; bb+=tAScaledPermanent )//not thoroughly vetted
{
                                              ...
                                              tolerance=((tolerance)/trunc)*trunc
                                                       ...
                                                       tolerance=(tolerance)**(((((-leafPermanent+1)*(grPermanent+1))/trunc)*trunc)*((totalAMPmodified+totalAMP)/2.)**.5+((totalAMPmodified+totalAMP)/2.)**2.) // this greatly improves trueness
