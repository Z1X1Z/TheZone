...
function move() {
 ...
 if(fromCenter>skyInterSection)
    ...
    if (((fromCenter - zoom**.75)> uniforms.SEVEYEStart.value && uniforms.seventhOUTside.value && uniforms.colorCombo.value <= 0)) {
...
;
    ...
    //if(pointerZoom)
    {
        ...
        else if (((fromCenter - zoom**.75)  > uniforms.SEVEYEStart.value && uniforms.seventhOUTside.value && uniforms.colorCombo.value <= 0.) && spunTouch[0] != 0 && spunTouch[1] != 0) {
