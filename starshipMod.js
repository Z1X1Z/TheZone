                         ...
                         // console.log(loops)
                          ...
                          //  phrase=phrase*(2)
                           ...
                           // for (var na = 0; na<3; na+=1)nudgeAdjust=totalAMP**nudgeAdjust
                                    tolerance+=(totalAMP)**(totalAMP/4.)*totalAMP+tolerance**(powerAMP*6.))//alsotolerance**(powerAMP**2*6) ; //*totalAMP**(powerAMP/3).;///4./fractionOfFrame may actually be a fixed 256 bytes
                                                                //             tolerance=((tolerance)/trunc)*trunc
