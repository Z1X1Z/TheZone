    ...
    for(let n = 0; n<metaLevel-level; n++)
    {
        polygons.push({
             ...
             caughtByDot:""
                                        ...
                                        let compound =baseMag/144.*interpolation*window.movementRate/pixelShaderToStarshipRATIO;
...
let tolerance=0;//(1024-26)/10000
                                                      ...
                                                      // let feedbackVal = grTimesLeaf;
                                                                 ...
                                                                 if(1==1) for(n=1;n<101;n++)//still runs as n gets very large, maybe 2 to odd?even?//14 works well, 4 doesn;t
                                                                 {
                                                  
                                                                      plusOrMinusPowerSeries = (tAScaled**(2**(-1.5/(n+plusOrMinusPowerSeries))//*grTimesLeaf
