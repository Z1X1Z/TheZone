                                                                                                         ...
                                                                                                         for (var bb =0; bb<1.5; bb+=tAScaledPermanent )//not thoroughly vetted
{
                                              ...
                                              tolerance=((tolerance)/trunc)*trunc
                                                       ...
                                                       tolerance=(tolerance)**(((((-leafPermanent+1)*(grPermanent+1))/trunc)*trunc)*((totalAMPmodified**.5+totalAMP**.5)/2.)**.5+(((totalAMPmodified**2+totalAMP**2)/2.))**2.) // this greatly improves trueness
