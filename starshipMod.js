...
window.twist-=window.spinnerTwist
  ...
  if(uniforms.spinner.value)  spunD=spin(spunD,twist/12.*Math.PI+Math.PI);
               ...
               //  d_y*=zoomBoost;
                ...
                if((fromCenter>uniforms.SEVEYEStart.value+zoom&&uniforms.seventhOUTside.value&&uniforms.colorCombo.value<=0))
{
                   if(fromCenter<81.)
...
function zoomRoutine(){
    ...
    if(seventhOUTside&&fromCenter>uniforms.SEVEYEStart.value)metaDepth=metaDepth*2**(uniforms.SEVEYEpow.value/(coordX**2+coordY**2)**.5+1)
                   ...
                   if(yTouch!=0){
                     ...
                     if((((coordX**2+coordY**2)**.5/zoom**.5<uniforms.SEVEYEStart.value||fromCenter==0.)&&uniforms.seventhOUTside.value&&uniforms.colorCombo.value<=0)||!uniforms.seventhOUTside.value)
                        infinicore();
                         ...
                         if((fromCenter>uniforms.SEVEYEStart.value+zoom&&uniforms.seventhOUTside.value&&uniforms.colorCombo.value<=0.)&&spunTouch[0]!=0&&spunTouch[1]!=0)
                   {
                   if(fromCenter<81.)
                   {
                            wrapMovementBoost=4.*fromCenter**.5/fromCenter;
