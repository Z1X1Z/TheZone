...
let tolerance=0;//(1024-26)/10000
                                                      ...
                                                      // let feedbackVal = grTimesLeaf;
                                                                // console.log(tAScaled)
                                                                 ...
                                                                 let loopsThresh = 1
                                                                 if(1==1) for(n=1;n<8;n+=1)//still runs as n gets very large, maybe 2 to odd?even?//14 works well, 4 doesn;t
                                                                 {
                                                                     let sig = Math.sign(n%2-.5);
                                                  console.log(n)
                                                                      plusOrMinusPowerSeries = (tAScaled**(2**(-1.5/(loopsThresh-3.*(plusOrMinusPowerSeries))*sig)//*grTimesLeaf
