...
{
                          tolerance*=((totalAMP**tolerance)**((1+totalAMP)**tolerance-tolerance)**((1.-tolerance)**totalAMP+totalAMP))///trunc)*trunc;//not exhaustively optimized, but intuitive and effective
