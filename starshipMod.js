                         ...
                         // console.log(loops)
                          ...
                          //  phrase=phrase*(2)
                           ...
                           // for (var na = 0; na<3; na+=1)nudgeAdjust=totalAMP**nudgeAdjust
                                    tolerance+=(totalAMP)**(totalAMP/4)*totalAMP+totalAMP**((totalAMP)*((2**.5)*3*4))/4//+(-leafPermanent+grPermanent+2**.5)/fractionOfFrame//tolerance+=(totalAMP)**(totalAMP/4)*totalAMP+totalAMP**((totalAMP)*(6*2*(2**.5)))
