...
*/
   if(seventhEYE>0.&&lengthP<2./3.
     ...
     if(squeezeN>1.&&(seventhEYE==0.||lengthP>2./3.))hyperCore-=1.;
...
if(//zoom<=.5&&counter==0.&&
    ...
    */
                s.multiplyScalar(Math.sqrt(lfc)*2./3.+1.);//maybe other values work?
...
{
      if(dilate)    s=freed(s.multiplyScalar(6.)).divideScalar(6.);//not sure this does anything, seems to improve vibrancy and vivacity and makes spokes much stabler
