...
let micProcessing1 = false;//autoGainControl//this was engaged to help cut down on noise, but no longer seems necessary, and the pitch is truer without
let micProcessing2 = true;//echoCancellation//this was engaged to help cut down on noise, but no longer seems necessary, and the pitch is truer without
...
letTouchThrough=false;
  ...
  {window.isTouch=true;
                     if(letTouchThrough!=false)     letTouchThrough=true;
  }
    ...
    document.getElementById( "load message").style.textAlign="center"
            document.getElementById( "load message").innerHTML = "Press to open (once it's loaded!)";//turn off splash!
